...
urlpatterns += [
    ...
    path('doctor-duty', views.doctor_duty_view, name='doctor-duty'),
    path('doctor-view-appointment', views.doctor_view_appointment_view, name='doctor-view-appointment'),
    path('doctor-duty-calendar', views.doctor_duty_calendar, name='doctor-duty-calendar'),
    path('doctor-leave', views.doctor_leave, name='doctor-leave'),
